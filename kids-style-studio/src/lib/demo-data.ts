...
export const DEMO_ITEMS: StudioItem[] = [
  // -- Hair (girl) --
  { id: "hair-girl-twin", name: "트윈테일", category: "hair", gender: "girl", imagePath: "/assets/items/hair/girl-twin-tails.png", thumbnail: "/assets/items/hair/girl-twin-tails.png", zIndex: 5 },
  ...
  { id: "hair-girl-pony", name: "포니테일", category: "hair", gender: "girl", imagePath: "/assets/items/hair/girl-ponytail.png", thumbnail: "/assets/items/hair/girl-ponytail.png", zIndex: 5 },
  // -- Hair (boy) --
  ...
  { id: "tops-girl-hoodie", name: "파스텔 후디", category: "tops", gender: "girl", imagePath: "/assets/items/tops/girl-hoodie.png", thumbnail: "/assets/items/tops/girl-hoodie.png", theme: "casual", zIndex: 3 },
  ...
  // -- Shoes --
  { id: "shoes-white", name: "하얀 운동화", category: "shoes", gender: "unisex", imagePath: "/assets/items/shoes/sneakers-white.png", thumbnail: "/assets/items/shoes/sneakers-white.png", zIndex: 4 },
  ...
  // -- Accessories --
  { id: "acc-glasses", name: "안경", category: "accessories", gender: "unisex", imagePath: "/assets/items/accessories/glasses.png", thumbnail: "/assets/items/accessories/glasses.png", zIndex: 8 },
